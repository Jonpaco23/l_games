...
proc new_Fitts {} {
    ...
    set ob(test) $ob(totTrials)
    while {[llength $ob(randModes)] != 2} {
        set randMode [irand 2]
...
proc fireTrigger {trigVal trigMsg} {
    wshm event_id $trigVal
    set command [exec python TriggerTests.py $trigVal]
    puts $command
    lappend ob(triggerVals) $trigVal
    puts "Trigger 16 sent! Break has been begun"
    set command [exec python TriggerTests.py 0]
    puts $command
    lappend ob(triggerVals) 0
