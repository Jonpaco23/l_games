...
class Control(object):
    ...
    def __init__(self):
        ...
        self.cursor = self.change_cursor("cross_dot")
    ...
    def make_cursor_dict(self):
        ...
        # cursor_image_new = pg.image.load("resources/images/reddot.png").convert()
        cursor_image_new = pg.image.load("new_dot.png").convert()
        ...
        cursors = {
            "cross"    : cursor_from_image(cursor_image, 32, (8,8)),
            ...
            "cross_dot": cursor_from_image(cursor_image_new, 64, (8,8)),
