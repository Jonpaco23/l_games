#! /usr/bin/wish
#
# This is to test an EEG Experiment in passive mode
#
# Developed by:
...
proc init_Fitts {} {
	...
	set ob(Break) 0
	set ob(pause) 0
	#grid [button .b0 -text "PAUSE" -command "set ob(pause) [expr !$ob(pause)]"]
...
proc start_experiment_start_log {} {
	global ob mob
		...
		set fn $mob(whoN)_$ob(timestamp)_passive.dat
...
proc domenu {} {
	...
	menu_t $m blank18 "     This is PASSIVE (robot moves)" ""
